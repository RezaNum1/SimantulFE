<template>
    ...
    <div class="dashboard-container-fluid-doc">
        <div>
            <div class="dashboard-section-title">
            ...
            <div class="dashboard-container-form">
                <label for="searchQuery" class="form-label" style="margin-top: 32px;">Dokumen</label>
                    <div v-if="model.report.status == 4">
                        <input
                                v-model="model.report.dokumenTemuan"
                                type="text"
                                id="searchQuery"
                    ...
                    <div v-else-if="model.report.status == 6">
                        <label for="searchQuery" class="form-label" style="margin-top: 32px;">{{ model.report.dokumenTemuan }}</label>
                    </div>
            </div>
        </div>
    </div>
    ...
    <div class="row" style="margin-left: 0px; margin-bottom: 80px; margin-top: 36px;">
        <button type="button" @click="openModal(true)" class="btn btn-accept">Kirim</button>
    </div>
